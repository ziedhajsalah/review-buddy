/**
 * Build the set of viewed file paths for a chapter from raw stored entries.
 ...
 */
export function viewedSet(entries: readonly unknown[], chapterIndex: number): Set<string> {
